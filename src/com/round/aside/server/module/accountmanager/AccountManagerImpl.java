...
public final class AccountManagerImpl implements IAccountManager {
    ...
    @Override
    public RegisterResultEntity registerAccount(String mAccount, String mPassword,String NickName,String Email,String PhoneNum) {
    ...
    public boolean activationEmail(int mUserID,String email){
        ...
        try{
            ...
            transport.connect(smtp, sendEmailAddress, sendEmailPassword);	         
